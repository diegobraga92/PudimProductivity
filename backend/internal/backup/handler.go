...
func (h *Handler) Export(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		shared.WriteError(w, http.StatusInternalServerError, "failed to export backup")
		return
	}
...
func (h *Handler) Import(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		shared.WriteError(w, http.StatusBadRequest, "failed to read backup body")
		return
	}
	if len(data) == 0 {
		shared.WriteError(w, http.StatusBadRequest, "backup body is empty")
		return
	}
	...
	if err := json.Unmarshal(data, &probe); err != nil {
		shared.WriteError(w, http.StatusBadRequest, "invalid backup: not a valid backup JSON document")
		return
	}
	...
	if err != nil {
		...
		shared.WriteError(w, http.StatusInternalServerError, "failed to import backup")
		return
	}
