...
func (h *Handler) ListEnabled(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		httpx.WriteError(w, http.StatusInternalServerError, "failed to list feature flags")
		return
	}
...
func (h *Handler) GetByName(w http.ResponseWriter, r *http.Request) {
	...
	if name == "" {
		httpx.WriteError(w, http.StatusBadRequest, "flag name is required")
		return
	}
	...
	if err != nil {
		...
		httpx.WriteError(w, http.StatusInternalServerError, "failed to get feature flag")
		return
	}

	httpx.WriteJSON(w, http.StatusOK, featureFlagResponse{
		Name:    name,
		Enabled: enabled,
	})
}
...
func (h *Handler) Toggle(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		httpx.WriteError(w, http.StatusInternalServerError, "failed to look up feature flag")
		return
	}
	if flag == nil {
		httpx.WriteError(w, http.StatusNotFound, "feature flag not found")
		return
	}
	...
	if err := h.service.SetEnabled(r.Context(), flag.ID, req.Enabled); err != nil {
		...
		httpx.WriteError(w, http.StatusInternalServerError, "failed to toggle feature flag")
		return
	}
